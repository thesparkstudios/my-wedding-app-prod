            ...
            <>
                  ...
                  {proposalData.packages.filter(p => p.isVisible).map((item) => (
                    <div key={item.id} className={`relative flex flex-col p-10 md:p-14 rounded-[3.5rem] border transition-all duration-1000 ${item.isHighlighted ? 'bg-white border-[#C5A059]/40 lg:scale-105 z-10 shadow-2xl' : 'bg-white border-slate-100'}`}>
                      ...
                      <div className="mb-14 md:mb-16">
                        ...
                        <div className="text-6xl md:text-8xl font-serif mb-10 text-slate-950 tracking-tighter leading-none font-serif">{item.price}</div>
              ...
              <section className="max-w-4xl mx-auto py-32 md:py-56 px-8 font-sans">
                <div className="text-center mb-24 font-serif">
                  ...
                  <p className="text-[11px] font-black text-slate-400 tracking-[0.5em] uppercase font-sans">Understanding our Studio Commitment</p>
                </div>
                ...
                <section className="bg-[#fafaf9] py-32 md:py-48 px-8 border-y border-slate-100 font-sans">
                  <div className="max-w-6xl mx-auto font-sans">
                    <div className="text-center mb-24 md:mb-32 font-serif">
                      ...
                      <p className="text-[11px] font-black text-slate-400 tracking-[0.5em] uppercase font-sans">Trusted by our Spark Couples</p>
                    </div>
                    ...
                    <div className="text-left font-sans leading-relaxed">
                      ...
                      <div className="space-y-16 font-sans">
                        <div className="flex gap-8 font-sans">
                          <div className="w-16 h-16 rounded-[1.5rem] border border-white/20 flex items-center justify-center shrink-0 shadow-lg shadow-black/50 font-sans"><Clock size={28} className="text-[#C5A059]" strokeWidth={1} /></div>
                          <div className="font-sans"><h4 className="font-black text-[11px] tracking-[0.4em] font-sans uppercase mb-4 text-[#C5A059] font-sans">Duration</h4><p className="text-xl font-sans font-bold text-white tracking-tight font-sans">Active for 30 days — Valid until {new Date((proposalData.createdAt || Date.now()) + (EXPIRY_DAYS * 24 * 60 * 60 * 1000)).toLocaleDateString()}</p></div>
                        </div>
                        <div className="flex gap-8 font-sans">
                          <div className="w-16 h-16 rounded-[1.5rem] border border-white/20 flex items-center justify-center shrink-0 shadow-lg shadow-black/50 font-sans"><Award size={28} className="text-[#C5A059]" strokeWidth={1} /></div>
                          <div className="font-sans"><h4 className="font-black text-[11px] tracking-[0.4em] font-sans uppercase mb-4 text-[#C5A059] font-sans">Booking Contract</h4><p className="text-xl font-sans font-bold text-white tracking-tight font-sans">A signed agreement formalizes all discussed timelines and investment details.</p></div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white text-slate-950 p-12 md:p-24 rounded-[4rem] md:rounded-[6rem] shadow-[0_80px_150px_-30px_rgba(0,0,0,0.8)] relative group overflow-hidden font-sans">
                      ...
                      <button onClick={() => openWhatsApp(`Hi Spark Studios! We'd like to schedule a Vision Call for the ${proposalData.clientName} celebration.`)} className="w-full bg-[#C5A059] text-white py-8 rounded-[2.5rem] font-black text-[11px] uppercase tracking-[0.5em] font-sans hover:bg-slate-950 transition-all shadow-2xl shadow-[#C5A059]/40 active:scale-95 flex items-center justify-center gap-4 font-sans">Connect on WhatsApp <MessageCircle size={20} /></button>
                    </div>
                  </div>
                  <div className="mt-48 md:mt-64 pt-20 border-t border-white/10 text-center font-sans"><p className="text-[11px] uppercase tracking-[1em] opacity-40 font-sans font-black leading-relaxed font-sans">The Spark Studios &copy; 2026 — Fine Art Cinematography</p></div>
                </div>
              </section>
            </>
          )}
